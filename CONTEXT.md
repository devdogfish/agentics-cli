...
- **Content library**: Git-backed source directory containing the agentic catalog and package files.
...
- **Migration import**: Bulk import from a source provider into the content library, then optional materialization into a Jawfish manifest.
